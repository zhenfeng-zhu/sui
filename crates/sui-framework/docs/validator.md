...
<b>use</b> <a href="unsecure.md#0x2_unsecure">0x2::unsecure</a>;
...
<pre><code><b>fun</b> <a href="validator.md#0x2_validator_verify_proof_of_possession">verify_proof_of_possession</a>(
    ...
    <b>assert</b>!(
        unsecure_verify_with_domain(&proof_of_possession, &pubkey_bytes, signed_bytes, <a href="validator.md#0x2_validator_PROOF_OF_POSSESSION_DOMAIN">PROOF_OF_POSSESSION_DOMAIN</a>) == <b>true</b>,
        0
    );
}
</code></pre>
